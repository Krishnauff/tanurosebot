        ...
        if len(args) >= 1:
            if args[0].lower() == "help":
                ...
                send_help(
                    ...
                    HELPABLE[mod].__markdown_help_senderhelp__,
            ...
            x=update.effective_message.reply_sticker(
                "CAACAgUAAxkDAAIBLGQ7oxoUEPO952FP6dnQwfc7tc8aAAJcCQACGrawVMXOdK150drCLwQ")
            x.delete()
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="📍𝐎𝐖𝐍𝐄𝐑📍", url=f"https://t.me/NO_LOVE_I_HATE_LOVE"
                        ),
                        InlineKeyboardButton(
                            text="🎄𝐑𝐄𝐏𝐎🎄", 
...
☆............𝙱𝚈 » [KRISHNA](https://t.me/Ajanabee_Duniya)............☆
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="{https://te.legra.ph/file/10b99b0e4790c56f7f3a6.jpg}",
                caption=f"""
{dispatcher.bot.first_name}

╔═════ஜ۩۞۩ஜ═════╗

  ♨️𝗠𝗔𝗗𝗘 𝗕𝗬 [𝐊𝐫𝐢𝐬𝐡𝐧𝐚 ɮՕT](https://t.me/NO_LOVE_I_HATE_LOVE)♨️
